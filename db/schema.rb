...
ActiveRecord::Schema[7.2].define(version: 2024_08_20_215516) do
  ...
  create_table "active_storage_variant_records", force: :cascade do |t|
    ...
    t.index ["variation_digest"], name: "index_active_storage_variant_records_on_variation_digest", unique: true
  end
  ...
  create_table "export_orders", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_export_orders_on_user_id"
  end
